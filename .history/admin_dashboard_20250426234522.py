...
def show_admin_dashboard():
    ...
    page = st.sidebar.radio("Navigation", ["Manage Users", "Question Bank Chatbot"])

    if page == "Question Bank Chatbot":
        st.sidebar.info("🚀 Redirecting to Chatbot page...")
        st.stop()  # ❌ Stop execution here (handled in the main app where Chatbot will be loaded)
