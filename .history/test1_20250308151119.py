...
if page == "Overview":
    ...
    if not df.empty:
        ...
        # Customized colors inspired by your logo, yet clearly distinguishable
        fig = px.pie(
            values=sentiment_counts.values,
            names=sentiment_counts.index,
            title="Sentiment Distribution",
            color_discrete_map={
                "Positive": "#C09B3E",   # Gold from logo
                "Negative": "#6E260E",   # Darker shade for negative
                "Neutral": "#F1C40F"     # Softer yellow for neutral
            }
        )
