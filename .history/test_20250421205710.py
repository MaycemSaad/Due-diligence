def show_due_diligence_app():
    ...
    from pptx.enum.shapes import MSO_SHAPE
    from datetime import datetime, timezone
    from Extraction_Text import extract_text_pdfplumber, clean_text, summarize_text
    ...
    if uploaded_file:
        ...
        # 📝 En option : journaliser l'upload dans les logs d'audit
        log_event(st.session_state.user, "document_upload", f"Uploaded {uploaded_file.name}")

        doc_text = extract_text_from_file(uploaded_file)
        st.session_state.chat_context = {uploaded_file.name: doc_text}
