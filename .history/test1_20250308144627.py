...
def apply_theme(theme):
    if theme == "Dark":
        return """
            <style>
                body { background-color: #0E1117; color: #E0C068; }
                .stApp { background-color: #0E1117; }
                h1, h2, h3, h4, h5, h6, p, label { color: #E0C068 !important; }
        ...
        return """
            <style>
                body { background-color: #FFFFFF; color: #9B7D2F; }
                .stApp { background-color: #FFFFFF; }
                h1, h2, h3, h4, h5, h6, p, label { color: #9B7D2F !important; }
                .sidebar .sidebar-content {
