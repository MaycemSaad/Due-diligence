...
if st.session_state.page == "login":
    ...
    # ======== TABS ===========
    # ========================
    tabs = st.tabs(["🏠 Home", "ℹ️ About", "💼 Services", "📞 Contact", "🛡️ Compliance Tools"])
    ...
    with tabs[4]:
        st.markdown("<h2 style='text-align: center; color: #2E3B4E;'>Compliance & Validation Tools</h2>", unsafe_allow_html=True)
        
        # Show all your tools here:
