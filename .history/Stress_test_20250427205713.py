# 🚀 Stress Test & Crypto Forecast - Advanced Streamlit App (Pro Version)
...
drop_pct_list = st.sidebar.multiselect("💥 Choquer (%) :", [10, 20, 30, 40, 50, 60, 70, 80, 90], [30])
...
model_choice = st.sidebar.radio("🧠 Modèle de prédiction :", ["ARIMA", "Prophet"], index=0)
