...
def visualize_data(df):
    ...
    # Bar Chart - Word Count per Document
    ...
    # Line Chart - Real-time Word Count Evolution
    fig3 = go.Figure()
...
st.markdown("""
    <style>
        ...
        .sidebar-content { padding: 20px; background: white; border-radius: 10px; box-shadow: 2px 4px 10px rgba(0, 0, 0, 0.1); }
        .stButton>button { background-color: #145DA0 !important; color: white !important; font-weight: bold; padding: 12px 20px; border-radius: 10px; }
    </style>
