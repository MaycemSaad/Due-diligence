...
<div style="margin-top: 5rem;">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h2 style="color: white; font-size: 2.5rem;">Our Recent Blog</h2>
    ...
    <div style="display: flex; gap: 30px; flex-wrap: wrap; margin-top: 2rem;">
        ...
        <div style="background-color: #111; padding: 1rem; border-radius: 12px; width: 250px;">
            <img src="https://via.placeholder.com/300x200/000000/FF0000?text=Image+1" style="width: 100%; border-radius: 10px;" />
        ...
        <!-- Blog Card 2 -->
        <div style="background-color: #111; padding: 1rem; border-radius: 12px; width: 250px;">
            <img src="https://via.placeholder.com/300x200/111111/00FFFF?text=Image+2" style="width: 100%; border-radius: 10px;" />
        ...
        <!-- Blog Card 3 -->
        <div style="background-color: #111; padding: 1rem; border-radius: 12px; width: 250px;">
            <img src="https://via.placeholder.com/300x200/220022/FF00FF?text=Image+3" style="width: 100%; border-radius: 10px;" />
            <p style="color: #06f; font-weight: bold; margin-top: 0.5rem;">MARKETING</p>
            <p style="color: #aaa; font-size: 0.9rem;">🕒 10 min read</p>
            <h4 style="color: white; font-size: 1.1rem; margin-top: 0.5rem;">Invalide purpose classes & motivation.</h4>
        </div>

        <!-- Blog Card 4 -->
        <div style="background-color: #111; padding: 1rem; border-radius: 12px; width: 250px;">
            <img src="https://via.placeholder.com/300x200/330066/FFFF00?text=Image+4" style="width: 100%; border-radius: 10px;" />
