...
page = st.sidebar.radio("Select a Page", ["Overview", "Q&A Data", "Engagement Analysis", "Sentiment Analysis", "NER & Topics", "Data Export", "Statistics",  "User Interaction Trends"])
...
if page == "Overview":
    ...
    daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity = daily_activity.groupby("date").size().reset_index(name="Interactions")
