...
if st.session_state.page == "login":
    ...
    with tabs[1]:
        ...
        <div class="card">
            ...
            <p>Chainvestor Hub is revolutionizing the investment decision-making process through AI and Blockchain technologies.</p>
        </div>
        """, unsafe_allow_html=True)

        # Timeline animation (Custom Timeline)
        st.markdown("""
        <div style="margin-top:40px;">
        <h4 style="color: #F4C430;">🚀 Our Journey</h4>
        <ul style="list-style: none; padding: 0;">
            <li style="margin-bottom: 15px;">
                <span style="color:#F4C430;">2019 - Foundation:</span> Chainvestor Hub was born to simplify crypto investments.
            </li>
            <li style="margin-bottom: 15px;">
                <span style="color:#F4C430;">2021 - Launch of AI Engine:</span> Integrating real-time risk analysis.
            </li>
            <li style="margin-bottom: 15px;">
                <span style="color:#F4C430;">2024 - Expansion:</span> Serving over 3,500 investors globally.
            </li>
        </ul>
        </div>
        """, unsafe_allow_html=True)

        lottie_about = load_lottie_url("https://assets7.lottiefiles.com/packages/lf20_bhw1ul4g.json")
        if lottie_about:
            st_lottie(lottie_about, height=300, speed=1, quality="high")
        else:
