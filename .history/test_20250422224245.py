def show_due_diligence_app():
    ...
    st.session_state.session_title = st.sidebar.text_input(
        "📝 Session Title",
    ...
    # Créer un mapping session → titre pour sélection
    session_options = {s["session"]: s.get("session_title", s["session"]) for s in chat_sessions}
    session_display_names = list(session_options.values())
