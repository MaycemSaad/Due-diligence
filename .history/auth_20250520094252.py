...
def show_verification_page():
    ...
    st.markdown('<div class="auth-title">🪪 Identity Verification</div>', unsafe_allow_html=True)

    st.warning("To finalize your registration, please upload your national identity card (CIN). This is required to ensure account security and authenticity.")

    st.markdown("""
    <ul>
        <li>📷 Upload a clear image of your ID card (front side).</li>
        <li>🔒 Your data is encrypted and only used for identity verification purposes.</li>
        <li>⏱️ Verification will take a few seconds.</li>
    </ul>
    """, unsafe_allow_html=True)

    if st.button("✅ Proceed to the Platform"):
