...
# 🔍 Classe de recherche sémantique (fallback si pas de PDF chargé)
class SemanticSearch:
    def __init__(self):
        self.index = faiss.IndexFlatL2(384)  # dimension de all-MiniLM-L6-v2
        self.documents = []
        self.model = SentenceTransformer("all-MiniLM-L6-v2")

    def load_index(self):
        # TODO: Charger depuis disque si persisté
        pass
    ...
    def search(self, query, top_k=3):
        ...
        return [(self.documents[i], float(i)) for i in I[0] if i < len(self.documents)]
...
# --- Traitement PDF Upload (via /upload)
