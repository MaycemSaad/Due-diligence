...
if st.session_state.page == "login":
    ...
    with col1:
        st.markdown("""
            <div style="background: #1f2937; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0px 0px 20px rgba(0,0,0,0.3);">
                <h2 style="color: #10b981; font-size: 2.5rem; margin-bottom: 0;">+1,500</h2>
                <p style="color: white; font-size: 1.1rem; margin-top: 0.5rem;">Entities Analyzed</p>
    ...
    with col2:
        st.markdown("""
            <div style="background: #1f2937; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0px 0px 20px rgba(0,0,0,0.3);">
                <h2 style="color: #10b981; font-size: 2.5rem; margin-bottom: 0;">+500</h2>
                <p style="color: white; font-size: 1.1rem; margin-top: 0.5rem;">Deals Verified</p>
    ...
    with col3:
        st.markdown("""
            <div style="background: #1f2937; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0px 0px 20px rgba(0,0,0,0.3);">
                <h2 style="color: #10b981; font-size: 2.5rem; margin-bottom: 0;">$1.2B+</h2>
                <p style="color: white; font-size: 1.1rem; margin-top: 0.5rem;">Assets Screened</p>
