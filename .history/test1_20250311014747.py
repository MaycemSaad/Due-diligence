...
page = st.sidebar.radio("Select a Page", ["Overview", "Q&A Data", "Engagement Analysis", "Sentiment Analysis", "NER & Topics", "Data Export", "Statistics", "Trending Topics", "Advanced Sentiment Analysis", "User Insights", "Data Export",  "User Interaction Trends"])
