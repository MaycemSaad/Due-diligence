...
selected_display = st.sidebar.selectbox(
    "📚 Load a past chat", ["Choose an option"] + session_display_names,
...
if selected_display != "Choose an option":
    selected_id = session_ids[session_display_names.index(selected_display)]
    if selected_id != st.session_state.session_name:
        doc = collection.find_one({"session": selected_id, "user_email": st.session_state.user})
        if doc:
