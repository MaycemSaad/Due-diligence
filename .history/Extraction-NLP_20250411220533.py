...
new_pdf_files = [
    ...
    # Ajoute tes autres fichiers ici...
]
...
def summarize_text(text):
    """Résumé avec modèle pré-entraîné BART"""
    max_input_len = 1024  # contrôle sécurité sur HuggingFace BART
    words = text.split()

    # Tronquer proprement si trop long
    if len(words) > max_input_len:
        text = " ".join(words[:max_input_len])

    # Calcul dynamique des longueurs
