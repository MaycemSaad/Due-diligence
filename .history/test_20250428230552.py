def show_due_diligence_app():
    ...
    # 🔐 Définir le titre si c'est la première question
    ...
    # ➡️ Affiche la question IMMÉDIATEMENT
    with st.chat_message("user"):
        st.markdown(question)

    # ➡️ Ajoute la question dans l'historique
    ...
    # ➡️ Affiche la réponse IMMÉDIATEMENT
