def show_due_diligence_app():
    ...
    def test_microphone():
        ...
        try:
            with sr.Microphone() as source:
                ...
                st.success("✅ Audio capturé. Vérifie le fichier 'test_audio.wav' dans le dossier courant.")
    ...
    # Lancer le test depuis Streamlit
    if st.sidebar.button("📝 Tester la reconnaissance"):
        recognize_from_file("test_audio.wav")
