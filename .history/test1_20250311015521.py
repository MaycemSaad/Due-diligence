...
page = st.sidebar.radio("Select a Page", ["Overview", "Q&A Data", "Engagement Analysis", "Sentiment Analysis", "NER & Topics" , "Statistics", "Trending Topics", "Advanced Sentiment Analysis", "Data Export",  "User Interaction Trends", "Chatbot Simulation & A/B Testing"])
