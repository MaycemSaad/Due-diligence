...
with st.sidebar:
    ...
    theme_mode = st.radio("Choose Theme", ["Light", "Dark"], index=1)
        ...
        if theme == "Dark":
            return """
                <style>
                    ...
                    .sidebar .sidebar-content { background-color: #1E293B !important; }
                    .stButton>button { background-color: #2ECC71; color: white; width: 100%; border-radius: 8px; padding: 10px; margin: 5px 0; }
                </style>
            """
        else:
            return """
...
if st.sidebar.button("🏠 Overview"):
    page = "Overview"
elif st.sidebar.button("📄 Q&A Data"):
    page = "Q&A Data"
elif st.sidebar.button("📊 Engagement Analysis"):
    page = "Engagement Analysis"
elif st.sidebar.button("📈 Sentiment Analysis"):
    page = "Sentiment Analysis"
elif st.sidebar.button("🔍 NER & Topics"):
    page = "NER & Topics"
elif st.sidebar.button("📥 Data Export"):
    page = "Data Export"
elif st.sidebar.button("📌 Statistics"):
    page = "Statistics"
elif st.sidebar.button("🖥️ Live Chat Monitoring"):
    page = "Live Chat Monitoring"
elif st.sidebar.button("📊 User Interaction Trends"):
    page = "User Interaction Trends"
else:
    page = "Overview"
