...
if st.session_state.page == "login":
    ...
    with tabs[2]:
        ...
        for col, (title, desc) in zip(cols2, premium_services):  # 🔥 Correction ici
            with col:
                st.markdown(f"""
                <div class="card-hover">
                    <h4 style="color: #F4C430;">{title}</h4>
...
# ==== Footer ====
st.markdown("""
<hr style="border: 1px solid #F4C430; margin-top: 50px; margin-bottom: 20px;">

<div style="text-align: center; color: #888; font-size: 16px; padding-bottom: 10px;">
    © 2025 Chainvestor Hub. All rights reserved.<br>
    Powered by AI & Blockchain Technologies.
</div>
