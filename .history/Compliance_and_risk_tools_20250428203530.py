...
def show_Tools():
    ...
    with tab4:
        st.markdown("<h2 style='text-align:center; color:#ffcc00;'>📱 Social Media Analysis</h2>", unsafe_allow_html=True)
        show_social_media_analysis()

    with tab5:
        st.markdown("<h2 style='text-align:center; color:#ffcc00;'>💹 Crypto Market Overview</h2>", unsafe_allow_html=True)
        show_crypto_market()

    with tab6:
        st.markdown("<h2 style='text-align:center; color:#ffcc00;'>🏛️ Crypto Companies Database</h2>", unsafe_allow_html=True)
