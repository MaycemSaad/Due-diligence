...
def show_admin_dashboard():
    ...
    # === Sidebar ===
    with st.sidebar:
        st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Streamlit_logo_vertical_primary_light.svg/512px-Streamlit_logo_vertical_primary_light.svg.png", width=140)
        st.markdown('<div class="sidebar-title">Due Diligence AI</div>', unsafe_allow_html=True)
        page = st.radio("Navigate", ["👥 Manage Users", "🤖 Chatbot"], label_visibility="collapsed")
