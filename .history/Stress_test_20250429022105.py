...
with st.expander("🧠 Explain AI Prediction (Feature Importance)"):
    st.info("Interpreting how past prices influenced future prediction...")
    ...
    st.subheader("🔍 SHAP Feature Importance (Last Prediction)")
    shap_plot = plt.figure()
    shap.summary_plot(shap_values, X, show=False, plot_type="bar")
    st.pyplot(shap_plot)

    # Display Force Plot (optional - per sample)
    st.subheader("⚡ SHAP Force Plot for a Random Forecast")
