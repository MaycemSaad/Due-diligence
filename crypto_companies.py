    ...
    if len(filtered_df) == 0:
        ...
        for idx, row in filtered_df.iterrows():
            ...
            with st.expander(f"🔍 See Trust Score & AI Summary for {company_name}"):
                ...
                trust_button = col1.button(f"Calculate Trust Score", key=f"trust_{idx}_{company_name}")
                summary_button = col2.button(f"Generate AI Summary", key=f"summary_{idx}_{company_name}")
